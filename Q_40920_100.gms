$title Stormwater management model: SUBID 40920, 100 yr rain
* Minimum water flow problem: Stormwater management
...
*n3 can retain up to 279128,72. This is higher than the inflow amount, so the inflow amount is used here instead.
...
Parameter
   u(i,j) 'Upper bound of capacity on arc from node i to node j'
            / n1.n2 2342.23, n1.n3 197267.34
              n2.n4 2342.23, n2.n5 2342.23
              n3.n4 197267.34,n2.n6 253.46
              n3.n6 21346.54, n6.n7 5400
              n6.n8 36000, n6.n9 21600
              n4.n9 2342.23 /;
...
Scalars
    ...
    w_w  'Weight of objective function for water' / 1 /
    ;
